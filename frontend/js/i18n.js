...
export const STRINGS = {
  en: {
    ...
    'board.still_to_account': 'still to account for',
    'board.never_seen': 'Never seen by any camera',
    'board.nowhere_to_look': 'Nobody is unaccounted for.',
    'board.search': 'Where to look',
    'board.why': 'Why this state?',
    'board.go_look': 'Send somebody to look',
    'board.needs_a_tick': 'Already outside — a warden must confirm them',
    'board.trend_falling': 'down',
    'board.trend_rising': 'up',
    'board.trend_flat': 'no change',
    'board.trend_over': 'in the last',
    'warden.remaining_only': 'Still to check',
    'warden.show_all': 'Show everyone',
    'warden.show_remaining': 'Show only what is left',
    'warden.all_checked': 'Everyone on this list has been checked.',
    ...
    'health.under_one_percent': 'under 1%',
    ...
    'timing.clock_moved': 'The clock was corrected during this drill — these are not measurements',
    ...
    'warden.cannot_remember': 'This device forgets itself when reloaded — keep this page open',
    'warden.theme_sunlight': 'Sunlight',
    'warden.theme_night': 'Night',
  ...
  ar: {
    ...
    'board.still_to_account': 'ما زال يجب حسابهم',
    'board.never_seen': 'لم تره أي كاميرا',
    'board.nowhere_to_look': 'لا يوجد أحد غير محسوب.',
    'board.search': 'أين تبحث',
    'board.why': 'لماذا هذه الحالة؟',
    'board.go_look': 'أرسل من يبحث',
    'board.needs_a_tick': 'بالخارج بالفعل — يجب أن يؤكدهم مسؤول',
    'board.trend_falling': 'انخفض',
    'board.trend_rising': 'ارتفع',
    'board.trend_flat': 'دون تغيير',
    'board.trend_over': 'خلال آخر',
    'warden.remaining_only': 'ما زال للتفقد',
    'warden.show_all': 'أظهر الجميع',
    'warden.show_remaining': 'أظهر ما تبقى فقط',
    'warden.all_checked': 'تم تفقد كل من في هذه القائمة.',
    ...
    'health.under_one_percent': 'أقل من ١٪',
    ...
    'timing.clock_moved': 'تم تصحيح الساعة أثناء هذا التمرين — هذه ليست قياسات',
    ...
    'warden.cannot_remember': 'هذا الجهاز ينسى هويته عند إعادة التحميل — أبقِ هذه الصفحة مفتوحة',
    'warden.theme_sunlight': 'وضع الشمس',
    'warden.theme_night': 'الوضع الليلي',
